...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        String loginUser = conexion.LoginUser(email,password);
        Log.d("conexion",loginUser);

        if( password.equals(loginUser)){

            Log.d("conexion","Congrats: Login Successfull");
            progressDialog.setMessage("OK");

        }
        else
        {
            Log.d("conexion","Congrats: Login ");
            progressDialog.setMessage("NOT OK");
        }
